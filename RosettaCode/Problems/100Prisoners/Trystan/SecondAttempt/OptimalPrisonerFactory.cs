...
/// <summary>
///     Provides a factory for creating prisoners that use an optimal search strategy.
/// </summary>
public class OptimalPrisonerFactory : IPrisonerFactory
{
    /// <summary>
    ///     Creates a new prisoner instance with the specified prisoner number and maximum search depth that uses the optimal search strategy.
    /// </summary>
    ...
    {
        return new OptimalPrisoner(prisonerNumber, maxSearchDepth);
    }
}